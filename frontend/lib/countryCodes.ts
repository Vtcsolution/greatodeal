...
// Countries Greatodeal actively serves, shown first in the picker.
const featured: CountryCode[] = [
...
// Every other country/territory with an assigned calling code, A-Z.
...
export const countryCodes: CountryCode[] = [...featured, ...rest];
