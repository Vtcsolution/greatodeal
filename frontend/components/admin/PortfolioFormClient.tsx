    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-3xl">
      ...
      <div className="bg-[#161616] rounded-2xl border border-white/10 p-5 sm:p-6 space-y-5">
        <div>
          ...
          <input value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Compliance Automation Platform for a Regional Bank" className={inputCls} />
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input value={category} onChange={e => setCategory(e.target.value)} placeholder="e.g. Fintech, Healthcare" className={inputCls} />
          </div>
          <div>
