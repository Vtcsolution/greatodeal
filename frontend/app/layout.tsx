...
const organizationSchema = {
  ...
  knowsAbout: [
    ...
    'API Development', 'HIPAA Compliance', 'Government Technology',
  ],
  areaServed: {
    '@type': 'GeoCircle',
...
const localBusinessSchema = {
  ...
  serviceType: ['Agentic AI Platforms', 'Compliance-Grade Infrastructure', 'Government AI Automation', 'Healthcare AI (HIPAA)', 'Fintech AI Automation', 'Secure Integration & Data Pipelines'],
  areaServed: [
